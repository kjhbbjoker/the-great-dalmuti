...
data class GameRoom(
    ...
    var currentTurnPlayer: PlayerDomain? = null,                // 현재 턴 플레이어
    var currentFieldCards: MutableList<Card> = mutableListOf(), // 현재 필드에 놓인 카드들
    var lastPlayedPlayer: PlayerDomain? = null,                 // 마지막으로 카드를 낸 플레이어
    var finishedPlayers: MutableList<PlayerDomain> = mutableListOf(), // 게임을 마친 플레이어들 (순위)
